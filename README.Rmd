...
Register an API token on [FMP Cloud](https://fmpcloud.io/) or [Financial Modeling Prep](https://financialmodelingprep.com/). To use the package without an API key, see the bottom section 'Examples using a demo API' for API calls on Apple. 
